  ...
  return (
    ...
    <Routes>
      ...
      <Route path='shopping' element={<ShoppingLayout/>}>
          ...
          <Route path='category' element={<Categorie BtnStyle="flex flex-wrap gap-6 mx-auto w-full"/>}/>
          <Route path='brand' element={<Brand BtnStyle="flex flex-wrap gap-6 mx-auto w-full"/>}/>
          <Route path='category/:categoryId' element={<CategoriesOverview/>}/>

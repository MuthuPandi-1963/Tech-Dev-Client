...
const ResetPasswordOTPThunk = createAsyncThunk("/verify_reset_password_otp",
    async (formData, { rejectWithValue }) => {
        try {
            console.log(formData);
            const response = await axiosInstance.post('/verify_reset_password_otp', formData, { withCredentials: true });
...
export default ResetPasswordOTPThunk;
